                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div x-data="{ selectedPekan: '{{ $pekanAktif }}' }" class="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-1.5">
                            ...
                            <select 
                                ...
                                class="rounded-lg border border-gray-300 bg-white py-1 px-2.5 text-xs font-semibold text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                            >
                            ...
                            <a 
                                ...
                                class="inline-flex items-center rounded-lg bg-red-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-sm transition hover:bg-red-700"
                            >
