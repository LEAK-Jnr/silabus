<div x-data="{ show: false, message: '', type: 'success' }" x-init="
        ...
        // 💡 Tetap pertahankan ini agar pesan dari redirect/session HTTP biasa (Non-Livewire) tetap muncul
        @if(session('success'))
    ...
    :class="type === 'success' ? 'border-emerald-500' : 'border-red-500'" style="display: none">
    <div class="p-4">
        <div class="flex items-start">
            <div class="ml-3 w-0 flex-1">
                <p class="text-sm font-bold text-gray-900" x-text="type === 'success' ? 'Berhasil!' : 'Gagal!'"></p>
