<div>
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between bg-white rounded-lg shadow-md mx-4 md:mx-10 p-4 md:p-5 mt-5 gap-3">
                        ...
                        @forelse ($this->jadwal as $ajuan)
                            <flux:table.row :key="$ajuan->id" class="align-middle">
                                ...
                                <flux:table.cell class="whitespace-nowrap">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="text-xs text-zinc-500">
                                            {{ $ajuan->jam_mulai?->format("H:i") }} - {{ $ajuan->jam_selesai?->format("H:i") }}
                                        </div>
                                        <div class="text-[10px] text-zinc-400">
                                            {{ $ajuan->jam_mulai?->format("d/m/Y") }}
                                        </div>
                                    </div>
                                </flux:table.cell>
                                ...
                                <flux:table.cell class="text-center whitespace-nowrap">
                                    <span class="inline-block px-2 py-0.5 rounded text-xs font-bold bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700">
                            ...
                            <flux:table.row>
                                <flux:table.cell colspan="7" class="text-center py-12">
                                    <div class="flex flex-col items-center justify-center space-y-2 text-zinc-400">
                                        ...
                                        <flux:text size="lg" class="font-medium">Tidak ada jadwal yang ditemukan.</flux:text>
                                    </div>
                                </flux:table.cell>
                            </flux:table.row>
                        @endforelse
