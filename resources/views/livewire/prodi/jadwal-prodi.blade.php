<div>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-6 shadow-xs sm:rounded-lg">
                <h3 class="mb-4 text-lg font-bold">
                    Jadwal Praktikum Program Studi
                </h3>
                <p class="text-gray-600">Lihat jadwal praktikum berdasarkan ruangan, pekan, dan program studi.
                </p>
            </div>
        </div>
    </div>
    ...
    {{-- subtitle --}}
    <flux:heading size="xl" class="text-center pt-4 text-black">Jadwal Praktikum</flux:heading>
    ...
    <div class="py-4">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-md p-4 md:p-5 mt-5 mb-5">
